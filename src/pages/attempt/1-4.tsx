        ...
        <main className='items-center w-full h-screen bg-slate-100'>
          <motion.div variants={thumbnailVariants} className='h-full'>
            ...
            <motion.div
              ...
              transition={{ delay: 2, duration: 1 }}
            >
              活動を始めた当初に全員で現場を回って各部署の5S活動を見学し
              <br />
              その知識と経験を参考に現在の活動を行っている
            </motion.div>
            <div className='flex'>
              <motion.div
              ...
              >
                <Image src='/1-4-1.jpg' width={600} height={450} alt='test' />
              </motion.div>
              <motion.div
                className='block m-auto mt-6 w-full text-center'
                initial={{ opacity: 0 }}
              ...
              >
                <Image src='/1-4-2.jpg' width={600} height={450} alt='test' />
              </motion.div>
            </div>
          </motion.div>
        </main>
